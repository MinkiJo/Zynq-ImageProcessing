...
HD_PWD='C:/zyboz720/imageProcessing_PS/imageProcessing_PS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log imageProcessing_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source imageProcessing_wrapper.tcl -notrace
