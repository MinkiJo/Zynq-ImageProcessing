...
HD_PWD='C:/zyboz720/imageProcessing_PS/imageProcessing_PS.runs/imageProcessing_axis_dwidth_converter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imageProcessing_axis_dwidth_converter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imageProcessing_axis_dwidth_converter_0_0.tcl
