...
HD_PWD='C:/zyboz720/imageProcessing_PS/imageProcessing_PS.runs/imageProcessing_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imageProcessing_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imageProcessing_rst_ps7_0_50M_0.tcl
