...
HD_PWD='C:/zyboz720/imageProcessing_PS/imageProcessing_PS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imageProcessing_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imageProcessing_wrapper.tcl
