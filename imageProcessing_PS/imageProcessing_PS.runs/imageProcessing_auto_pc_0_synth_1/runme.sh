...
HD_PWD='C:/zyboz720/imageProcessing_PS/imageProcessing_PS.runs/imageProcessing_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imageProcessing_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imageProcessing_auto_pc_0.tcl
